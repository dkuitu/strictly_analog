<?php ?>
<footer class="pv4 ph3 ph5-ns tc bg-light-gray bt bw1">
    <small class="f6 db tc">© 2017 <b class="ttu">Strictly Analog Inc</b>, All Rights Reserved</small>
    <div class="tc mt3">
    ...
    <div class="pv4 ph3 ph5-ns tc">
        <a class="link near-black hover-silver dib h2 w2 mr3" href="https://facebook.com title=" title="Facebook">
        ...
        <a class="link hover-silver near-black dib h2 w2 mr3" href="https://tumblr.com" title="Tumblr">
            <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill-rule="evenodd"
                 clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
                <path d="M9.708 16c-3.396 0-4.687-2.504-4.687-4.274V6.498H3.403V4.432C5.83 3.557 6.412 1.368 6.55.12c.01-.086.077-.12.115-.12H9.01v4.076h3.2v2.422H8.997v4.98c.01.667.25 1.58 1.472 1.58h.067c.424-.012.994-.136 1.29-.278l.77 2.283c-.288.424-1.594.916-2.77.936h-.12z"
                      fill-rule="nonzero"/>
            </svg>
        </a>
